    ...
    <section id="contact" class="contact mb-5">
      <div class="container" data-aos="fade-up">
        ...
        <form action="post.php" method="post" role="form" class="php-email-form">
                <input type="text" name="communityGroup" id="communityGroup" class="form-control" placeholder="Your Community Group" required>
                <input type="text" name="eventTitle" id="eventTitle" class="form-control" placeholder="Your Event Title" required>
                <input type="text" name="datetime" id="datetime" class="form-control" placeholder="Your Event Date [Format: day-month-year]" required>
           ...
           include 'serverlogin.php';
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
              ...
              if ($conn->connect_error) {
                ...
                // Get form data
                $communityName = $_POST['communityGroup'];
                $eventTitle = $_POST['eventTitle'];
                $eventDate = $_POST['datetime'];
                $time = $_POST['time'];
                $eventType = $_POST['eventType'];
                $image = $_POST['image'];
                $imageLocation = "files/images/events/" . $image;
                ...
                $insertQuery = "INSERT INTO Events (EventID, EventTypeID, GroupID, EventDate, SubmitDate, EventTitle, EventImage, EventDesc) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
                $statement = $conn->prepare($insertQuery);
                $statement->bind_param("iiisssss", $newEventID, $eventTypeId, $groupId, $eventTime, $submitTime, $eventTitle, $imageLocation, $message);
                $statement->execute();
