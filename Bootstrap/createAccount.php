  ...
  <main id="main">
    <section id="contact" class="contact mb-5">
      <div class="container" data-aos="fade-up">
        ...
        <div class="form mt-5">
        <form action="createAccount.php" method="post" r ole="form" class="php-email-form">
            <div class="row">
          ...
          <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($checkUsernameResult->num_rows > 0) {
                    ...
                    $insertGroupQuery = "INSERT INTO Groups (GroupName, EventType, ContactName, ContactEmail, GroupImage, Description) 
                                        VALUES ('$groupName', '$eventType', '$contactName', '$contactEmail', '$groupImage', '$description')";
                    if ($conn->query($insertGroupQuery) === TRUE) {
                        ...
                        $insertLoginQuery = "INSERT INTO Login (GroupID, Username, Password) 
                                            VALUES ('$groupID', '$userName', '$hashedPassword')";
                        if ($conn->query($insertLoginQuery) === TRUE) {
                            ...
                            echo "Error: " . $insertLoginQuery . "<br>" . $conn->error;
                        }
                    } else {
