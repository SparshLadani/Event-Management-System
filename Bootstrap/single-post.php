      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <ul>
              ...
              echo '<li class="dropdown"><a href="single-post.php?eventName=Art%2bCulture&eventtype=Art%2bCulture"><span>Art+Culture</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>';
                echo '<ul>';
                ...
                echo'</ul>';
              echo'</li>' ;
              echo'<li><a href="single-post.php?eventName=Sports&eventtype=Sport">Sport</a></li>';
              echo'<li><a href="single-post.php?eventName=Food&eventtype=Food">Food</a></li>';
              echo'<li><a href="single-post.php?eventName=Fund raiser&eventtype=Fund Raiser">Fund Raiser</a></li>';
                            ...
                            <?php
                              ...
                              if ($upcoming_result->num_rows > 0) {
                                  while($row = $upcoming_result->fetch_assoc()) {
                                      ...
                                      echo '<h2 class="mb-2"><a href="#">' . $eventTitle . '</a></h2>';
