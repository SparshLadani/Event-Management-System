      ...
      <div class="container" data-aos="fade-up">
        ...
        <?php
          ...
          if ($_SERVER["REQUEST_METHOD"] == "POST") {
              ...
              $accountId = "SELECT AccountID FROM login WHERE Username = '$username'";
              $groupId = "SELECT GroupID FROM login WHERE Username = '$username'";
              $result = $conn->query($sql);
              $executeAccountId = mysqli_query($conn, $accountId);
              $executeGroupId = mysqli_query($conn, $groupId);
              $fetchedAccountId = '';
              $fetchedGroupId = '';
              if (isset($executeAccountId) && isset($executeGroupId)) {
                $accountRow = mysqli_fetch_assoc($executeAccountId);
                $groupRow = mysqli_fetch_assoc($executeGroupId);
                $fetchedAccountId = $accountRow['AccountID'];
                $fetchedGroupId = $groupRow['GroupID'];
              }
